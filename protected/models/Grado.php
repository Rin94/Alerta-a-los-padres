...
class Grado extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('rango', 'required'),
            array('rango', 'length', 'max' => 45),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, rango', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'grupos' => array(self::HAS_MANY, 'Grupo', 'grado_id'),
        );
    }
   ...
   public static function getListGrado(){
            return TbHtml::listData(Grado::model()->findAll(),'id','rango');
        }
