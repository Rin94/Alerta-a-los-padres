...
/**
 * This is the model class for table "padre".
 *
 * The followings are the available columns in table 'padre':
 * @property integer $id
...
class Padre extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'alumnos' => array(self::MANY_MANY, 'Alumno', 'alumno_has_padre(padre_id, alumno_id)'),
	 ...
	 * @return Padre the static model class
	 */
